...
{
    /// <summary>
    /// Interaction logic for Request_Confirmation_Dialog.xaml
    /// </summary>
    public partial class Request_Confirmation_Dialog : UserControl
    {
        ...
        public Request_Confirmation_Dialog(string title, string text)
        {
            InitializeComponent();
            pTitle = title;
            pText = text;
