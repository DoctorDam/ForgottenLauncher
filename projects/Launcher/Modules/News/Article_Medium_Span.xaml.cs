...
{
    /// <summary>
    /// Interaction logic for Article_Medium_Span.xaml
    /// </summary>
    public partial class Article_Medium_Span : Button
    {
        private Newton_Main.WebsiteArticlesResponse pArticle;

        public Article_Medium_Span(Newton_Main.WebsiteArticlesResponse article)
        {
            InitializeComponent();
            pArticle = article;
        }
        ...
        private void Button_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                authorHolder.Text = pArticle.Author;
                dateHolder.Text = pArticle.Date;
