...
{
    /// <summary>
    /// Interaction logic for Character_Span.xaml
    /// </summary>
    public partial class Character_Span : UserControl
    {
        private Newton_Main.CharactersListResponse pCharacter;

        public Character_Span(Newton_Main.CharactersListResponse character)
        {
            InitializeComponent();
