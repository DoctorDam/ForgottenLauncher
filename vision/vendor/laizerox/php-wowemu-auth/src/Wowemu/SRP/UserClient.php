...
class UserClient extends Client
{
    ...
    public function GetVendettaVerifier(string $vendettaToken): string
    {
        $privateKeyVendetta = $this->computePrivateKeyVendetta($vendettaToken);
        $verifier = $this->computeVerifier($privateKeyVendetta);

        return $verifier->toHex();
    }

    public function computePrivateKeyVendetta(string $vendettaToken): BigInteger
    {
        if (empty($this->salt)) {
