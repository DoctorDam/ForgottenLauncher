...
class ZONES
{
    public static function Get_Name(int $zone_id)
    {
        if (array_key_exists($zone_id, self::$ZONES_LIST))
        {
            return self::$ZONES_LIST[$zone_id];
        }
        else
        {
            return "Undefined zone id..";
        }
    }

    protected static $ZONES_LIST = [
